...
class TestSelectFieldDefaults:
    ...
    def test_every_lanelet2_id_is_picked_off_the_map(self) -> None:
        ...
        allowed_text = {
            ...
            # The same regulatory element under the same name, reached by the
            # action and the condition that put a junction into a phase and
            # read it back, and unpickable for the same reason.
            ("traffic_signal_controller", "lanelet2_regulatory_element_id"),
        }
