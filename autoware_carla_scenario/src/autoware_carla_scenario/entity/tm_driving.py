...
:class:`~autoware_carla_scenario.entity.backend_driven.BackendDriven`, which
...
LaneChangeDirection`` keeps working for the actions, the tests and any scenario
package written against it.  New code should import
:class:`~autoware_carla_scenario.entity.backend_driven.BackendDriven` and the
