...
* **simple-lanelet2** (>\=1.1.2): Drop-in reimplementation of the Lanelet2 Python API with a Rust core, providing both the `lanelet2` and `autoware_lanelet2_extension_python` import paths as prebuilt wheels
